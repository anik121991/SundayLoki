...
public class Array_Hashmap_Hashset_HashTable {
	...
	public static void main(String[] args) {
		...
		String[] nameLoki = new String  []{"Anik", "Pushirul", "Joy", "marjan", "rishikesh"}; 
		...
		System.out.println("System Age 2D : " + ageLoki2D[0][1]);
...
//Hashmap store multiple data using key-value pair, Implementation of map interface
	...
	Capital.put("USA","Washington DC");
		...
		System.out.println("HashMap Capital City : "+ Capital.get("USA"));
